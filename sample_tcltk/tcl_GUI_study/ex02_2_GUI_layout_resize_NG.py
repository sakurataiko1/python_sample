#
# ■　python GUI tcl/tk ウィンドウ全体リサイズ時にウィジェットサイズも伸縮させる
# NG例：columnconfigure, rowconfigure を設定していない場合
...
class MainWindow(tk.Frame):
    def __init__(self, master=None):
        ...
        #self.master.columnconfigure(0, weight=1)  # 横のリサイズ追従
        #self.master.rowconfigure(2, weight=1) 　　 # 縦のリサイズ追従　# 画面リサイズ時の、部品リサイズ追従は frame02=canvasのみ

        msg = "NG例：columnconfigure, rowconfigure を設定していない場合\n"
